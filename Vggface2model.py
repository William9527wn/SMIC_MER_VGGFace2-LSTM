...
class Resnet50_128(nn.Module):
    ...
    def sub_forward_8(self, conv4_1):
    ...
    def sub_forward_9(self, conv4_2):
    ...
    def sub_forward_10(self, conv4_3):
    ...
    def sub_forward_11(self, conv4_4):
    ...
    def forward(self, data):
        data = self.sub_forward_7(data)
        data = self.sub_forward_8(data)
        data = self.sub_forward_9(data)
        data = self.sub_forward_10(data)
        data = self.sub_forward_11(data)
        return data

    def grad_layer(self, layer, data):
